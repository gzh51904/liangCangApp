          ...
          <li v-for="(item,index) in goodslist" :key="index">
            <el-col :span="2">
              <div class="grid-content bg-purple bg-purple2" style="line-height:80px">
                <span
                  class="tui-checkbox"
                  :class="{'tui-checked':item.checked}"
                  @click="check(item)"
                />
              </div>
            </el-col>
            ...
            <!-- 删除 -->
            <el-col :span="4">
              <div class="grid-content bg-purple bg-purple2 del" @click="remove(item.id,index)">删除</div>
            </el-col>
          </li>
        </ul>
      </div>
      ...
      <el-row>
        <el-col :span="8">
          <div class="grid-content bg-purple bg-purple2 checkall_button" style="font-size:16px;">
            <span class="tui-checkbox" :class="{'tui-checked':checkAllFlag}" @click="checkAll()" />
            <span>全选</span>
          </div>
        </el-col>
        <el-col :span="8">
  ...
  data() {
    return {
      ...
      goodslist: [
        {
          id: 1,
          imgurl: require("../assets/img/milk.jpg"),
          title: "牛奶",
          price: 66.0,
          number: 2
        },
        {
          id: 2,
          imgurl: require("../assets/img/canju.jpg"),
          title: "杯子",
          price: 66.0,
          number: 2
        },
        {
          id: 3,
          imgurl: require("../assets/img/touyingyi.jpg"),
          title: "投影仪",
          price: 2266.0,
          number: 2
        },
        {
          id: 4,
          imgurl: require("../assets/img/shuiju5.jpg"),
          title: "杯子",
          price: 66.0,
          number: 2
        },
        {
          id: 5,
          imgurl: require("../assets/img/zazhiji.jpg"),
          title: "榨汁机",
          price: 66.0,
          number: 2
        },
        {
          id: 6,
          imgurl: require("../assets/img/xiangxun.jpg"),
          title: "香薰",
          price: 266.0,
          number: 2
        },
        {
          id: 7,
          imgurl: require("../assets/img/zhutai.jpg"),
          title: "烛台",
          price: 166.0,
          number: 2
        }
